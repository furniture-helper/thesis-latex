...
The remaining tree structure then becomes the \textbf{anchor tree}, which is a representation of the common structure of the pages.
...
\subsection{Anchor Tree Generation}\label{subsec:anchor_tree_generation}
