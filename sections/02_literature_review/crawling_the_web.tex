\section{Crawling the Web}\label{sec:crawling_the_web}
...
\subsection{Summary}\label{subsec:web_crawling_summary}

Web crawling involves a range of technical and ethical considerations.
Static crawlers are simple and efficient but fail on JavaScript-heavy pages, while headless browser-based crawlers handle dynamic content and client-side rendering at highest resource costs.
Anti-bot measures and legal/ethical constraints add further complexity that must be carefully managed in any crawling system.
Table~\ref{tab:web_crawling_summary} summarises the key crawler types and their trade-offs.
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{p{4cm} X X}
        \toprule
        \textbf{Crawler Type} & \textbf{Strengths} & \textbf{Limitations} \\
        \midrule
        ...
        \bottomrule
    \end{tabularx}
    \caption{Summary of web crawler types and their trade-offs}
    \label{tab:web_crawling_summary}
\end{table}
