...
Out of the total of 116,962 unique URLs crawled, \texttt{72,899} were classified as product pages, while \texttt{44,063} were classified as non-product pages.
If only the product pages are considered, within the last 3 days, a total of \texttt{71,241} URLs were crawled, which means that \texttt{1,658} pages missed the 72-hour update requirement.
